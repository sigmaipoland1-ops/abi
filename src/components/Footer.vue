  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-content">
        <div>
          <img src="/images/logo.png" alt="Abiria" class="footer-logo">
          <p class="footer-tagline">Domowa hodowla labradorów z pasją</p>
        </div>
      ...
      <div class="footer-bottom">
        <p class="copyright">© {{ currentYear }} Abiria. Wszystkie prawa zastrzeżone.</p>
      </div>
    </div>
  </footer>
</template>
